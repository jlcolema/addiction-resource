...
*/
get_template_part('header-multi-step');?>
<style type="text/css">
  /* Style the form */
#regForm {
  ...
  width: 95%;
  min-width: 300px;
  box-shadow: 7px 7px 80px 0 rgba(0,0,0,.1);
  text-align: center;
}
...
ul.mf-option li:last-child {
  margin-right: 0;
}
ul.mf-option li label{
  padding: 10px 25px !important;
    border: 1px solid #24ace1;
    cursor: pointer;
    margin: 0 auto;
    font-weight: 600;
    border-radius: 3px;
...
ul.mf-option li label.multi-lrg {
  min-width: 215px;
  }
ul.mf-option li input {
    display:block;
    position:absolute;
    top:0;
    left:0;
...
ul.mf-option li input[type="radio"] {
    opacity:0;
    z-index:100;
}
ul.mf-option li label input[type="radio"]:checked {
    background:yellow;
}
ul.mf-option li:hover {
...
#regForm select.form-control:not([size]):not([multiple]) {
    height: auto;
}
#regForm input {
  font-family: inherit;
  ...
  <div class="page-wrapper">
      ...
      <div class="container">
        <div class="row content">
          <div class="col-12">
           <form id="regForm" action="" method="POST" onsubmit="submitted=true;" target="hidden_iframe">



<!-- One "tab" for each step in the form: -->
<div class="tab">
  <h3>I'm seeking help for...</h3>
...
<div class="tab">
  <h3>How soon do you need treatment?</h3>
  <ul class="mf-option m-hide">
    <li>
      <label>
...
<div class="tab">
  <h3>I'm seeking treatment for...</h3>
  <ul class="mf-option m-hide">
    <li>
      <label>
...
<div class="tab">
  <h3>Will you go through withdrawal if you stopped using?</h3>
  <ul class="mf-option m-hide">
    <li>
      <label>
...
<div class="tab">
  <h3>How will you pay for treatment?</h3>
    <ul class="mf-option m-hide">
    <li>
...
<div class="tab">
  <h3>Last Step!</h3>
  <p>We need a bit more information to connect you to treatment options.</p>
  <div class="row">
<div class="form-group col-md-6 col-12">
<input placeholder="Full Name" id="contact_name" class="form-control">
  </div>
<div class="form-group col-md-6 col-12">
<input placeholder="Phone Number" id="contact_number" class="form-control">
</div>
...
function showTab(n) {
  ...
  if (n == (x.length - 1)) {
    ...
    document.getElementById("nextBtn").className = "btn btn-md btnMain btnMultiStep";
  } else {
