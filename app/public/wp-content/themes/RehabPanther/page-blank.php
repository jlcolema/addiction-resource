              ...
              <?php if( have_rows('date_options') ): ?>
                <?php while( have_rows('date_options') ): the_row(); ?>
                  ...
                  <?php if( get_sub_field('date_choice') == 'Date Published' ): ?>
                    <p class="pdt">Published on <span itemprop="datePublished"><?php the_sub_field('date_published'); ?></span> | Written by the AddictionResource Editorial Team</p>
                  <?php endif; ?>
                  <?php if( get_sub_field('date_choice') == 'Date Modified' ): ?>
                    <p class="pdt">Updated on <span itemprop="dateModified"><?php the_sub_field('date_edited'); ?></span> | Written by the AddictionResource Editorial Team</p>
                  <?php endif; ?>
                  <?php if( get_sub_field('date_choice') == 'Date Published & Modified' ): ?>
                    <p class="pdt">Updated on <span itemprop="dateModified"><?php the_sub_field('date_edited'); ?></span> | Published on <span itemprop="datePublished"><?php the_sub_field('date_published'); ?></span> | Written by the AddictionResource Editorial Team</p>
                  <?php endif; ?>
                <?php endwhile; ?>
              <?php endif; ?>
      ...
      <div class="container">
        <div class="row content">
          <div class="col-md-8 col-12">
            ...
            <a class="collapsed tsa" data-toggle="collapse" data-parent="#articleSources" href="#collapseSources" aria-expanded="false" aria-controls="collapseSources">
                Article resources</i>
            </a>
